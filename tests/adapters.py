...
import cs336_basics.transformer.norm as norm
import cs336_basics.transformer.attn as attn
import cs336_basics.transformer.ffn as ffn
...
def run_get_batch(
    ...
    """
    return loader.data_loading(dataset, batch_size, context_length, device)
...
def run_cross_entropy(
    ...
    return attn.cross_entropy(inputs, targets)
...
def run_gradient_clipping(
    ...
    """
    adamw.gradient_clipping(parameters, max_l2_norm)
...
def run_save_checkpoint(
    ...
    """
    loader.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    # raise NotImplementedError
    return loader.load_checkpoint(src, model, optimizer)
